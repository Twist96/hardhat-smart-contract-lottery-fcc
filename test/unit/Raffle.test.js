...
!developmentChains.includes(network.name)
    ...
    : describe("Reffle", () => {
          ...
          describe("constructor", function () {
              it("initializes the reffle correctly", async function () {
          ...
          describe("enterRaffle", function () {
              ...
              it("records plyaers when they entered", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  const deployerFromContract = await raffle.getPlayer(0)
                  assert.equal(deployerFromContract, deployer)
              })
          ...
          describe("checkUpkeep", function () {
              ...
              it("returns false if enough times hasn't passed", async function () {
                  ...
                  await network.provider.send("evm_mine", [])
                  const { upkeepNeed } = await raffle.callStatic.checkUpkeep("0x")
                  assert(!upkeepNeed)
              })
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("called only be called after perfomUpkeep", async function () {
                  await expect(
